...
<html>
    <head>
        <title>Remove from Cart - Serial Nonsense</title>
        <style>
            body
            {
    ...
    <body>
        <?php
            ...
            try
            {
                ...
                $query = 'DELETE FROM CART WHERE Uname = "'.$uname.'" AND NumInCart = "'.$itemno.'"';
                ...
                {
                    echo 'Something went wrong and the item could not be deleted from the cart.';
                }
