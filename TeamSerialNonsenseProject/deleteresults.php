...
<html>
    <head>
        <title>Search Results for Deletion - Serial Nonsense</title>
        <style>
            body
            {
    ...
    <body>
        <?php
            ...
            echo '<form action="deleteresults.php" method="post" style="float: right; margin-right: 20px; margin-top: 30px; text-align: right">';
            echo 'Search Type:';
            ...
            if($allp == false)
            {
                try
                {
                    ...
                    for ($i=0; $i <sizeof($result); $i++)
                    {
                        ...
                        echo '<td>';
                            echo '<form action="deletedproduct.php" method="post" style="float: right; margin-right: 10px">';
                                if(isset($uname))
                                {
                                    echo '<input type="hidden" id="uname" name="uname" value='.$uname.'>';
                                    echo '<input type="hidden" id="owner" name="owner" value='.$owner.'>';
